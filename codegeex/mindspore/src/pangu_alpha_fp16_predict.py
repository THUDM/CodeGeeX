...
class PanguAlpha_Model(Cell):
    ...
    def load_embedding_from_ckpt(self, load_ckpt_path):
        ...
        self.print(
            "PanguAlpha_Model: load_word_embedding",
            self.embedding.word_embedding.embedding_table,
        )
        ...
        self.print(
            "PanguAlpha_Model: load_position_embedding",
            self.embedding.position_embedding.embedding_table,
        )
        ...
        self.print(
            "PanguAlpha_Model: top_query_embedding",
            self.embedding.top_query_embedding.embedding_table,
        )
